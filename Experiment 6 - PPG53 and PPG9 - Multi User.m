...
trainData_1 = FinalDataSegment(1:sZ,:);
train_label_1 = train_labelA(1:sZ);
...
testData_1 = FinalDataSegment(sZ+1:rowA,:);
test_label_1 = train_labelA(sZ+1:rowA);
...
[maxR,maxC] = size(FinalDataSegment);
if maxR < rowX
    Rw = maxR;
else
    Rw = rowX;
...
trainData_2     = FinalDataSegment(1:Rw,:);
train_label_2   = train_labelB(1:Rw);
testData_2      = FinalDataSegment(Rw+1:Ry,:);
test_label_2    = train_labelB(Rw+1:Ry);
